...
APP_NAME = 'ChucksList' # 'DJ4E Samples'   # Add
...
ROOT_URLCONF = 'mysite.urls' # 'dj4e-samples.urls'
...
WSGI_APPLICATION = 'mysite.wsgi.application' # 'dj4e-samples.wsgi.application'
...
#        'NAME': 'marcohph$django4e',
#        'USER': 'marcohph',
#        'PASSWORD': 'django4e',
#        'HOST': 'marcohph.mysql.pythonanywhere-services.com',
#        'OPTIONS': {
